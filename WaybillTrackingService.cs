...
namespace AutoJMS
{
    public class WaybillTrackingService
    {
        ...
        {
            var url = RuntimeConfigManager.Current.BuildJmsApiUrl("operatingplatform/podTracking/inner/query/keywordList");
        ...
        {
            var url = RuntimeConfigManager.Current.BuildJmsApiUrl("operatingplatform/order/getOrderDetail");
