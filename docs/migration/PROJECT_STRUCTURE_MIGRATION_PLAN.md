...
- `infra/` for DataHub, Firebase, and GitHub release reference files.
...
- Preserve update flow: Inno first install, Velopack in-app updates, GitHub binaries, DataHub manifests.
