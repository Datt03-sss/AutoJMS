...
| P1 | Stabilize GitHub Release + DataHub manifest update flow | Update phải predictable, không upload binary lớn lên DataHub | `release/*`, `docs/release/*`, `docs/manual/*` | Medium | Planned |
