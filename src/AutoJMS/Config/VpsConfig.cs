...
namespace AutoJMS
{
    public class DataHubManifestUrls
    {
    ...
    public class VpsReleasesConfig
    {
    ...
    public class DataHubLicenseConfig
    {
        ...
        public DataHubManifestUrls Manifests { get; set; } = new();

        [JsonPropertyName("releases")]
        public VpsReleasesConfig Releases { get; set; } = new();
    }
    ...
    public class CfgSubObject
    {
        ...
        [JsonPropertyName("datahub")]
        public DataHubLicenseConfig DataHub { get; set; }
    }
    ...
    public class VersionChannel
    {
        ...
        // "datahub"/null → legacy VPS config API feed (velopackFeedUrl)
        ...
        // Legacy VPS config API feed (kept for backward compatibility).
